...
_l'immagine è "Carovana araba all'esterno di una città fortificata in Egitto" di Jean-Léon Gérôme_

Oh primo post del 2026, buon anno!

![frieren](/img/frieren.gif)

In realtà questa è una bloggata di risposta a [quanto scriveva](https://cantina.ragnate.la/accountability-sagra-indieweb-gennaio-2026/) il buon [Ed](https://livellosegreto.it/@ed), utilissima perché mi porta a una riflessione più vasta riguardo il web contemporaneo e in particolare a tutto il suo circuito "alternativo".
...
Anche perchè i numeri in quanto tali valgono quel che valgono, se poi non si traducono in partecipazione e interesse (e al massimo sono solo [e-penis](https://www.urbandictionary.com/define.php?term=e-penis) che cola). 

### I problemi veri

Negli ultimi anni credo che le criticità principali del discorso IndieWeb siano risultate queste: 

- **Comunicazione**: i feed RSS sono belli, ma non so quanto possano aiutare in questo discorso - anche perché non servono per il discorso _scoperta_, che è cruciale. 
...
![Rebecca Ferguson](https://upload.wikimedia.org/wikipedia/commons/7/78/Rebecca_2018.png)
