---
layout: postita
title: "Il feed RSS in soldoni"
subtitle: "Le cose che vuoi leggere, quando vuoi leggerle"
sommario: "Proviamo a spiegare in poche parole cos'è e come funziona un feed RSS e la sua importanza per la diffusione di notizie nella rete."
...
Qualche giorno fa ho parlato di [AldusRSS](/posts/aldusrss/), il mio programmino per leggere feed RSS, e confrontandomi con i tester uno dei vari discorsi che è saltato fuori più o meno suonava così:

**"Xab, ma cos'è 'sto feed RSS?"**

(non vale per tutti eh!)

Sul momento pensavo di linkare direttamente [wikipedia](https://it.wikipedia.org/wiki/RSS) e amen, ma...
...
(e se state pensando a _Postalmarket_ siete dei veri birbanti).
...
In più, e questo riguarda soprattutto gli interessi dei giornali, **un social tendenzialmente non vuole che tu abbandoni la sua app/sito**, perciò penalizza i link esterni, laddove un lettore RSS è fatto _proprio_ per proporre le notizie e rimandare direttamente alla fonte, senza voler trattenere nessuno.
...
Se vuoi vederne uno per curiosità, puoi fare una prova con quello di questo blog [qui](/feed.xml)
...
Come detto ti serve un lettore RSS, ovvero un programma o una app che raccoglie tutti i feed a cui ti iscrivi (ce ne sono di ottimi anche gratuiti, tipo [NewsFlash](https://apps.gnome.org/it/NewsFlash/), e ovviamente se sei qui perché hai cliccato il link di [AldusRSS](/posts/aldusrss/)) ne stai già usando uno!

### E come trovo i Feed?

Su tantissimi siti trovi in giro una iconcina tipo questa:

![Icona RSS](https://upload.wikimedia.org/wikipedia/commons/4/43/Feed-icon.svg)
