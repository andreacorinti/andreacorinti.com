...
lang: it-IT
eleventyComputed:
  title: "{% if pagination.pageNumber > 0 %}Internet - pagina {{ pagination.pageNumber | plus: 1 }}{% else %}Internet{% endif %}"
  sommario: "{% if pagination.pageNumber > 0 %}Post su internet e il fediverso dal blog di Andrea Corinti - pagina {{ pagination.pageNumber | plus: 1 }}.{% else %}Post su internet e il fediverso dal blog di Andrea Corinti.{% endif %}"
pagination:
    data: collections.internet
    size: 8
    alias: postita
    reverse: true
permalink: "/categoria/internet-{{ pagination.pageNumber }}/"
---
...
<main id="main-content" class="tdbc-container">
  <nav class="tdbc-categorie-nav" aria-label="Categorie del blog">
    ...
    <a href="/categoria/internet-0/" class="tdbc-button tdbc-button-outlined tdbc-button--small is-active">Internet</a>
