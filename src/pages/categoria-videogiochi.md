...
lang: it-IT
eleventyComputed:
  title: "{% if pagination.pageNumber > 0 %}Videogiochi - pagina {{ pagination.pageNumber | plus: 1 }}{% else %}Videogiochi{% endif %}"
  sommario: "{% if pagination.pageNumber > 0 %}Post sui videogiochi dal blog di Andrea Corinti - pagina {{ pagination.pageNumber | plus: 1 }}.{% else %}Post sui videogiochi dal blog di Andrea Corinti.{% endif %}"
pagination:
    data: collections.videogiochi
    size: 8
    alias: postita
    reverse: true
permalink: "/categoria/videogiochi-{{ pagination.pageNumber }}/"
---
...
<main id="main-content" class="tdbc-container">
  <nav class="tdbc-categorie-nav" aria-label="Categorie del blog">
    ...
    <a href="/categoria/videogiochi-0/" class="tdbc-button tdbc-button-outlined tdbc-button--small is-active">Videogiochi</a>
