...
lang: it-IT
eleventyComputed:
  title: "{% if pagination.pageNumber > 0 %}Fumettame - pagina {{ pagination.pageNumber | plus: 1 }}{% else %}Fumettame{% endif %}"
  sommario: "{% if pagination.pageNumber > 0 %}Post su fumetti, manga e anime dal blog di Andrea Corinti - pagina {{ pagination.pageNumber | plus: 1 }}.{% else %}Post su fumetti, manga e anime dal blog di Andrea Corinti.{% endif %}"
pagination:
    data: collections.fumettame
    size: 8
    alias: postita
    reverse: true
permalink: "/categoria/fumettame-{{ pagination.pageNumber }}/"
---
...
<main id="main-content" class="tdbc-container">
  <nav class="tdbc-categorie-nav" aria-label="Categorie del blog">
    ...
    <a href="/categoria/fumettame-0/" class="tdbc-button tdbc-button-outlined tdbc-button--small is-active">Fumettame</a>
